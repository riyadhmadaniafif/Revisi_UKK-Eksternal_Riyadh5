        ...
        <div class="row justify-content-center">
          ...
          <div class="card-body">
            <form action="/updatedata2/{{ $data->id }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                <label for="exampleInputdeskripsifoto" class="form-label">Judul Foto</label>
              ...
              <div class="mb-3">
                <label for="exampleInputusia" class="form-label">Masukkan Foto</label>
                <input type="text" class="form-control" id="exampleInputmasukkanfoto" name="masukkanfoto" value="{{ $data->masukkanfoto }}"">
              </div>
